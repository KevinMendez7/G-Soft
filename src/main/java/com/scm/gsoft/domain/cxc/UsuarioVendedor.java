...
/**
 * UsuarioVendedor generated by hbm2java
 */
@Entity
@Table(name = "usuario_vendedor")
public class UsuarioVendedor implements java.io.Serializable {
	...
	public UsuarioVendedor(Long cia) {
		this.cia = cia;
	}

	public UsuarioVendedor(Long cia, String usuarioOs, String codigo, String nombre, Character statReg, String usuario,
			Date fechaIngreso) {
		this.cia = cia;
