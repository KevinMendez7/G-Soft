...
/**
 * MaebodPreciosHist generated by hbm2java
 */
@Entity
@Table(name = "maebod_precios_hist")
public class MaebodPreciosHist implements java.io.Serializable {
	...
	public MaebodPreciosHist() {
	}

	public MaebodPreciosHist(String codArt, String anio, String bodega, String noPieza, Float precioMin,
			Float precioMax, Float descMin, Float descMax, Character statReg, String usuario, Date fechaIngreso,
