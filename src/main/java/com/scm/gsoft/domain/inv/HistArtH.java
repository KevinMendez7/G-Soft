...
/**
 * HistArtH generated by hbm2java
 */
@Entity
@Table(name = "hist_art_h")
public class HistArtH implements java.io.Serializable {
	...
	public HistArtH(Character transa, String tipo, String bodega, String numero, String descri, Date fecha,
			String concepto, String proveedor, String factura, String polisa, String campo, String bodega2,
			String tipoT, String vendedor, String bodeguero, String requisicion, Character statReg, String usuario,
			Date fechaIngreso, Character timestampColumn) {
		this.transa = transa;
		this.tipo = tipo;
		this.bodega = bodega;
		this.numero = numero;
