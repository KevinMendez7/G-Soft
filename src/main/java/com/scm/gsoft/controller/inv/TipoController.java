...
import com.scm.gsoft.service.inv.TipoService;
...
public class TipoController {
	...
	public ResponseEntity<?> createTipo(@RequestBody Tipo tipo, UriComponentsBuilder uriComponentsBuilder){
		...
		if(tipo.getNombre().equals(null)||tipo.getNombre().isEmpty()) {

			return new ResponseEntity("Name can't be null", HttpStatus.CONFLICT);

		}

		if(_tipoService.getTipoByName(tipo.getNombre()) != null) {
		...
		Tipo newTipo = _tipoService.getTipoByName(tipo.getNombre());
