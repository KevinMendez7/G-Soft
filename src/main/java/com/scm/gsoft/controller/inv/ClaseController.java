...
import com.scm.gsoft.service.inv.ClaseService;
...
public class ClaseController {
	...
	public ResponseEntity<?> createClase(@RequestBody Clase clase, UriComponentsBuilder uriComponentsBuilder){
		...
		if(clase.getCodClase().equals(null)||clase.getCodClase().isEmpty()) {

			return new ResponseEntity("Name can't be null", HttpStatus.CONFLICT);

		}

		if(_claseService.getClaseByName(clase.getCodClase()) != null) {
		...
		Clase newClase = _claseService.getClaseByName(clase.getCodClase());
